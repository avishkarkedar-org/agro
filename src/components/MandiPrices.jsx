...
const PUNE_STATIC = [
  ...
  {
    commodity: "Coriander (Dhania)",
    variety: "Badami / Green Eagle",
    market: "Pune APMC",
    min_price: "7200",
    modal_price: "8400",
    max_price: "9800",
